      ...
      <div className="relative h-[45vh] w-full">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center">
          <div className="max-w-3xl">
            ...
            Fuel Your Ambition with Our Courses
            </h1>
            <p className="text-xl text-muted-foreground">
            Explore endless learning opportunities with our expertly designed courses.
            Gain insights from industry experts and elevate your skills to new heights.
            </p>
          </div>
        </div>
      </div>
